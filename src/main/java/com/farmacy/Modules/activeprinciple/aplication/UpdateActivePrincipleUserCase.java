...
public class UpdateActivePrincipleUserCase {
    private final ActivePrincipleService activePrincipleService;

    public UpdateActivePrincipleUserCase(ActivePrincipleService activePrincipleService) {
        this.activePrincipleService = activePrincipleService;
    }

    public void execute(ActivePrinciple activePrinciple, int idAp) {
        activePrincipleService.updateActivePrinciple(activePrinciple, idAp);
    }
}